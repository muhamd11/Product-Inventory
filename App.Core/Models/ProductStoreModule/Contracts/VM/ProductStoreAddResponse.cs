...
{
    public class ProductStoreAddResponse : BaseResponse
    {
        [JsonPropertyOrder(4)]
        public ProductInfoDetails productInfoData { get; set; }

        public ProductStoreAddResponse CreateResponse(string message, EnumStatus status, ProductInfoDetails? data = null)
        {
            if (data == null)
