...
namespace Api.Controllers.ProductsModules.ProductStores.Services
{
    internal class ProductStoresValid : IProductStoresValid
    {
        ...
        public ProductStoresValid(IUnitOfWork unitOfWork, IProductValid productsValid, IColorsValid colorsValid, IUnitsValid unitsValid)
        {
