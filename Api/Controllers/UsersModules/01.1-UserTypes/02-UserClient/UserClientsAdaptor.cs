...
namespace Api.Controllers.UsersModule.Users
{
    ...
    {
        public static Expression<Func<BaseUser, UserClientInfo>> SelectExpressionUserClientInfo()
        {
        ...
        public static Expression<Func<BaseUser, UserClientInfoDetails>> SelectExpressionUserClientDetails()
        {
        ...
        public static UserClientInfo SelectExpressionUserClientInfo(BaseUser user)
        {
            if (user == null)
                return null;
        ...
        public static UserClientInfoDetails SelectExpressionUserClientDetails(BaseUser user)
        {
            if (user == null)
                return null;
