...
namespace App.EF.Migrations
{
    ...
    [Migration("20240713154125_AddFieldsToUserClient3")]
    partial class AddFieldsToUserClient3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Shared.Models.ProductsModules._02._3_ProductWishlist.ProductWishlist", b =>
                {
            ...
            modelBuilder.Entity("App.Shared.Models.ProductsModules._02._3_ProductWishlist.ProductWishlistItems.ProductWishlistItem", b =>
                {
                    b.Property<int>("productWishlistItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("productWishlistItemId"));
                    ...
                    b.HasIndex("productWishlistId");

                    b.ToTable("ProductWishlistItem");
                });
            ...
            modelBuilder.Entity("App.Shared.Models.ProductsModules._02._3_ProductWishlist.ProductWishlist", b =>
                {
                    b.HasOne("App.Shared.Models.Buyers.UserClient", null)
                        ...
                        .HasForeignKey("App.Shared.Models.ProductsModules._02._3_ProductWishlist.ProductWishlist", "userClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("App.Shared.Models.ProductsModules._02._3_ProductWishlist.ProductWishlistItems.ProductWishlistItem", b =>
                {
                    b.HasOne("App.Shared.Models.ProductsModules._02._3_ProductWishlist.ProductWishlist", null)
                        .WithMany("productWishlistItems")
                        .HasForeignKey("productWishlistId");
                });
            ...
            modelBuilder.Entity("App.Shared.Models.ProductsModules._02._3_ProductWishlist.ProductWishlist", b =>
                {
                    b.Navigation("productWishlistItems");
                });
