...
namespace App.EF.Migrations
{
    ...
    [Migration("20240717094713_AddWishlist")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Shared.Models.OnlineStoreModule.WishlistItems.WishlistItem", b =>
                {
                    ...
                    b.Property<int>("wishlistItemProductId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("wishlistItemProductId");
            ...
            modelBuilder.Entity("App.Shared.Models.OnlineStoreModule.WishlistItems.WishlistItem", b =>
                {
                    b.HasOne("App.Shared.Models.ProductsModules._02._3_ProductWishlist.Wishlist", null)
                        .WithMany("wishlistItemsData")
                        .HasForeignKey("wishlistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("App.Shared.Models.Products.Product", "WishlistItemProductData")
                        .WithMany("wishlistItems")
                        .HasForeignKey("wishlistItemProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("WishlistItemProductData");
                });
            ...
            modelBuilder.Entity("App.Shared.Models.ProductsModules._02._3_ProductWishlist.Wishlist", b =>
                {
                    b.Navigation("wishlistItemsData");
                });
